            ...
            <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-8">
                ...
                @auth
                    <div class="bg-palermo-card border border-palermo-green/30 rounded-2xl p-5 min-w-[260px]">
                        ...
                        <a href="{{ route('profile.index') }}" class="inline-block mt-3 text-sm text-palermo-green hover:text-white transition-colors">
                            Перейти в корзину →
                        </a>
                    </div>
                @else
                                ...
                                @auth
                                    <div class="grid gap-3">
                                        <button
                                            ...
                                            name="purchase_mode"
                                            value="activate"
                                            class="w-full bg-palermo-green text-black font-bold py-3 rounded-xl hover:bg-green-500 transition-colors"
                                        >
                                            Купити і активувати на сервері
                                        </button>
                                        ...
                                        <button
                                            ...
                                            name="purchase_mode"
                                            value="inventory"
                                            class="w-full bg-gray-900 border border-gray-700 text-gray-200 font-bold py-3 rounded-xl hover:border-palermo-green hover:text-palermo-green transition-colors"
                                        >
                                            Купити в інвентар
                                        </button>
                                    </div>
